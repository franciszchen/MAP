...
# Define file paths
brain_file = "./MIMIC-iv/mimic-iv-2.2/hosp/diagnoses_icd.csv/diagnoses_icd_seq1_subj1_brain_v3.csv"
icd_ref_file = "./MIMIC-iv/mimic-iv-2.2/hosp/d_icd_diagnoses.csv/d_icd_diagnoses.csv"
output_file = "./MIMIC-iv/mimic-iv-2.2/hosp/diagnoses_icd.csv/diagnoses_icd_seq1_subj1_brain_v4.csv"
